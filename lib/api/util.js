...
let activity = {
    ...
    properties that are not in the above structure are set to `null` for speed.
    This function is pivotal to the application, since all other modules and the
    ui expect normalized keys
    */
    normalize: response => {
    ...
    is_upload: response => response.contentDetails.upload !== undefined,
