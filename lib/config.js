...
function update (trans, new_config, cb) {
    // sanitize new_config
    ...
    delete new_config.last_checked;  // don't want to be writting that into db
    basic_configs.map(preset => _type_correction(new_config, ...preset));
